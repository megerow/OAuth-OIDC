    ...
    [FromQuery] string? resource, [FromQuery] string? scope, [FromQuery] string? state) =>
{
    ...
    // Return a lightweight, raw HTML string to act as the login/consent form
    var html = $@"
        <html>
        <body style='font-family: sans-serif; max-width: 400px; margin: 50px auto; padding: 20px; border: 1px solid #ccc; border-radius: 8px;'>
            ...
            <form action='/login' method='POST'>
                ...
                <div style='margin-bottom:15px;'>
                    ...
                    <input type='email' name='email' value='jane.doe@example.com' style='width:100%; padding:8px;' required />
                </div>
                <div style='margin-bottom:15px;'>
                    <label>Password:</label><br/>
                    <input type='password' name='password' value='password123' style='width:100%; padding:8px;' required />
                </div>
